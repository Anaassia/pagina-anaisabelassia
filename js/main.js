  ...
  sec.innerHTML =
    '<div class="wrap">' +
      ...
      '<div class="follow-links">' +
        ...
        '<a class="follow-ic" href="https://wa.me/573116279068" target="_blank" rel="noopener" aria-label="Escríbeme por WhatsApp"><span class="ic">' + WA + '</span><span class="lbl">WhatsApp</span></a>' +
      '</div>' +
      '<p class="follow-handle">@anaisabelassia</p>' +
    '</div>';
